...
\begin{multicols}{4}
    ...
    d) 14
\end{multicols}
\item Let a smooth curve $y=f\brak{x}$ be such that the slope of the tangent at any point \brak{x,y} on it is directly proportional to $\frac{-y}{x}$. If the curve passes through the point \brak{1,2} and \brak{8,1}, then $\abs{y\brak{\frac{1}{8}}}$ is equal to 
\begin{multicols}{4}
    a) $2\ln 2$\\
    b) 4\\
    c) 1\\
